...
#define HZ_PROFILE 0
	...
	#define HZ_PROFILE_BEGIN_SESSION(name, filepath) ::Atum::Instrumentor::Get().BeginSession(name, filepath)
	#define HZ_PROFILE_END_SESSION() ::Atum::Instrumentor::Get().EndSession()
	#define HZ_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Atum::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Atum::InstrumentationTimer timer##line(fixedName##line.Data)
